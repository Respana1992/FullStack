...
namespace Aplicacion.Cursos
{
    ...
    {
        public class Ejeucta : IRequest<PaginacionModel>
        {
        ...
        public class Manejador : IRequestHandler<Ejeucta, PaginacionModel>
        {
            ...
            public async Task<PaginacionModel> Handle(Ejeucta request, CancellationToken cancellationToken)
            {
